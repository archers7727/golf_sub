...
DROP POLICY IF EXISTS "Users can insert course times" ON course_times;
DROP POLICY IF EXISTS "Users can update their own course times" ON course_times;
DROP POLICY IF EXISTS "Admins and authors can update course times" ON course_times;
DROP POLICY IF EXISTS "Users can delete their own course times" ON course_times;
DROP POLICY IF EXISTS "Admins and authors can delete course times" ON course_times;
...
DROP POLICY IF EXISTS "Users can insert join persons" ON join_persons;
...
DROP POLICY IF EXISTS "Admins and managers can update join persons" ON join_persons;
DROP POLICY IF EXISTS "Admins and managers can delete join persons" ON join_persons;
...
DROP POLICY IF EXISTS "Admins and authors can manage black lists" ON black_lists;
